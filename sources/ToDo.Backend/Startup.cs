...
namespace ToDo.Backend
{
    public sealed class Startup
    {
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            app.UseStaticFiles();
            app.UseClientSideBlazorFiles(typeof(Frontend.Program).Assembly.Location);
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapFallbackToClientSideBlazor(typeof(Frontend.Program).Assembly.Location, "index.html");
            });
        }
    }
}